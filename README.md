...
The cockpit ships with a deterministic synthetic quarter (four regions, ~€12M quota, week 9 of 13) so it runs the moment it loads. The **Upload CSV** button accepts a deals/opportunities export from any CRM — it auto-detects account, amount and stage columns, lets you map the rest, and recomputes attainment, pipeline and forecast on your own deals. Nothing leaves the browser.
